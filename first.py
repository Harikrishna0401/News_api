from flask import Flask , render_template , url_for , flash , redirect , request , session , logging , Blueprint
...
def entertainment():
    ...
    for i in range(len(articles)):
        ...
        mylist = zip(news, desc, img, link)
    return render_template('entertainment.html', context=mylist)
